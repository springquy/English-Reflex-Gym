...
export const MOCK_DATA: Question[] = [
  ...
  { id: 30, category: "Công việc", level: "Hard", vietnamese: "Tôi phụ trách dự án marketing.", main_answer: "I am in charge of the marketing project.", variations: ["I manage the marketing project", "I lead the marketing team"], hint: { structure: "S + be + in charge of + N", vocab: "Marketing, Project" }, note: "Cấu trúc tương tự câu 13, thay đổi phòng ban." },
  ...
  { id: 26, category: "Du lịch", level: "Easy", vietnamese: "Trạm xe buýt gần nhất ở đâu?", main_answer: "Where is the nearest bus station?", variations: ["Where is the closest bus stop", "Do you know where the bus stop is"], hint: { structure: "Where + is + the + nearest + Place?", vocab: "Bus station, Nearest" }, note: "Cấu trúc 'Where is...' áp dụng cho mọi địa điểm." },
  { id: 27, category: "Du lịch", level: "Easy", vietnamese: "Hiệu thuốc ở đâu?", main_answer: "Where is the pharmacy?", variations: ["Where is the drugstore", "Is there a pharmacy nearby"], hint: { structure: "Where + is + the + Place?", vocab: "Pharmacy" }, note: "Mỹ hay dùng Drugstore." },
  ...
  { id: 28, category: "Du lịch", level: "Hard", vietnamese: "Làm ơn chỉ đường cho tôi đến viện bảo tàng.", main_answer: "Please show me the way to the museum.", variations: ["How do I get to the museum", "Can you direct me to the museum"], hint: { structure: "Show/Tell + O + the way + to + N", vocab: "Museum, Way" }, note: "Tương tự câu hỏi về ga tàu." },
  ...
  { id: 29, category: "Nhà hàng", level: "Medium", vietnamese: "Tôi muốn đặt phòng khách sạn cho tối nay.", main_answer: "I would like to book a hotel room for tonight.", variations: ["I want to reserve a room", "Do you have any rooms available"], hint: { structure: "S + would like to + book + O", vocab: "Hotel room, Tonight" }, note: "Cấu trúc 'Book' dùng cho bàn ăn, vé, phòng khách sạn." },
  ...
  { id: 31, category: "Hàng ngày", level: "Medium", vietnamese: "Tôi phải đi đến trường để đón con.", main_answer: "I have to go to school to pick up my children.", variations: ["I need to pick up my kids at school"], hint: { structure: "S + have to + V + to + V", vocab: "School, Pick up" }, note: "Cấu trúc 'have to go to...' rất thông dụng." },
